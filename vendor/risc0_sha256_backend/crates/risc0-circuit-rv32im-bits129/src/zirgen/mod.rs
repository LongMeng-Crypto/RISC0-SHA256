...
pub(crate) mod circuit {
    ...
    macro_rules! set_field {
        (BabyBear6) => {
            pub type CircuitField = risc0_zkp::baby_bear_ext6::BabyBear6;
            pub type Val = <CircuitField as risc0_zkp::field::Field>::Elem;
            pub type ExtVal = <CircuitField as risc0_zkp::field::Field>::ExtElem;
...
impl CircuitCoreDef<BabyBear6> for CircuitImpl {}
