...
/// C ABI representation of a degree-six BabyBear extension element.
#[repr(C)]
pub struct RawBabyBearExt6 {
    pub elems: [BabyBearElem; 6],
}
...
extern "C" {
    pub fn risc0_circuit_rv32im_bits129_cpu_witgen(
        mode: u32,
    ...
    pub fn risc0_circuit_rv32im_bits129_cpu_accum(
        buffers: *const RawAccumBuffers,
        preflight: *const RawPreflightTrace,
        cycles: u32,
    ) -> *const std::os::raw::c_char;

    pub fn risc0_circuit_rv32im_bits129_cpu_poly_fp(
        cycle: usize,
        steps: usize,
        poly_mixs: *const RawBabyBearExt6,
        args_ptr: *const *const BabyBearElem,
        result: *mut RawBabyBearExt6,
    ) -> *const std::os::raw::c_char;
}

#[cfg(feature = "cuda")]
extern "C" {
    pub fn risc0_circuit_rv32im_bits129_cuda_witgen(
        mode: u32,
        buffers: *const RawExecBuffers,
        preflight: *const RawPreflightTrace,
        cycles: u32,
    ...
    pub fn risc0_circuit_rv32im_bits129_cuda_accum(
        buffers: *const RawAccumBuffers,
        preflight: *const RawPreflightTrace,
        cycles: u32,
    ) -> *const std::os::raw::c_char;

    pub fn risc0_circuit_rv32im_bits129_cuda_eval_check(
