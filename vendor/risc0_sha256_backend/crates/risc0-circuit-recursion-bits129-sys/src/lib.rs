...
pub struct RawPreflightTrace {
    pub wom: *const RawBabyBearExt6,
    pub cycles: *const RawPreflightCycle,
    pub iops: *const RawBabyBearExt6,
    pub num_woms: u32,
    pub num_cycles: u32,
    pub num_iops: u32,
}
...
extern "C" {
    pub fn risc0_circuit_recursion_bits129_cpu_witgen(
        mode: StepMode,
    ...
    pub fn risc0_circuit_recursion_bits129_cpu_accum(
        buffers: *const RawAccumBuffers,
        work_cycles: u32,
        total_cycles: u32,
    ) -> *const std::os::raw::c_char;

    pub fn risc0_circuit_recursion_bits129_cpu_eval_check(
        buffers: *const RawAccumBuffers,
        poly_mix: *const RawBabyBearExt6,
...
#[cfg(feature = "cuda")]
extern "C" {
    pub fn risc0_circuit_recursion_bits129_cuda_witgen(
        mode: StepMode,
        buffers: *const RawExecBuffers,
        preflight: *const RawPreflightTrace,
        steps: u32,
    ...
    pub fn risc0_circuit_recursion_bits129_cuda_accum(
        buffers: *const RawAccumBuffers,
        steps: u32,
        cycles: u32,
    ) -> *const std::os::raw::c_char;

    pub fn risc0_circuit_recursion_bits129_cuda_eval_check(
        check: *const BabyBearElem,
