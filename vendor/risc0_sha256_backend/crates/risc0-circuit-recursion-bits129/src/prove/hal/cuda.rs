...
use risc0_circuit_recursion_bits129_sys::{
    risc0_circuit_recursion_bits129_cuda_accum, risc0_circuit_recursion_bits129_cuda_eval_check,
    risc0_circuit_recursion_bits129_cuda_witgen, RawAccumBuffers, RawExecBuffers,
...
impl<CH: CudaHash> CircuitWitnessGenerator<CudaHal<CH>> for CudaCircuitHal<CH> {
    fn generate_witness(
        ...
        ffi_wrap(|| unsafe {
            risc0_circuit_recursion_bits129_cuda_witgen(mode, &buffers, preflight, total_cycles)
        })
    }
}
...
impl<CH: CudaHash> CircuitAccumulator<CudaHal<CH>> for CudaCircuitHal<CH> {
    fn accumulate(
        ...
        ffi_wrap(|| unsafe {
            risc0_circuit_recursion_bits129_cuda_accum(&buffers, work_cycles, total_cycles)
        })
    }
}
...
impl<CH: CudaHash> CircuitHal<CudaHal<CH>> for CudaCircuitHal<CH> {
    fn eval_check(
        ...
        ffi_wrap(|| unsafe {
            risc0_circuit_recursion_bits129_cuda_eval_check(
